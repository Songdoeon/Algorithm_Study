...
class Solution {
    ...
    void search(int depth, int[] rPoint, int[] bPoint, boolean[][] rVisited, boolean[][] bVisited, boolean rFinished, boolean bFinished){
        ...
        if(bFinished) {
            ...
            for(int i = 0;i < 4; i++){
                ...
                for(int j = 0; j < 4; j++){
                    ...
                    search(depth + 1, newR, newB, rVisited, bVisited, newRF, newBF);
    ...
    public int solution(int[][] maze) {
        ...
        xLen = maze.length;
        this.maze = maze;
        boolean[][] rVisited = new boolean[xLen][yLen];
        boolean[][] bVisited = new boolean[xLen][yLen];
        ...
        search(0, rStart, bStart, rVisited, bVisited, false, false);
